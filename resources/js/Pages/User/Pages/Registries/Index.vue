                            ...
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tr v-for="registry of registries" :key="registry.id"
                                    ...
                                    <td class="border-t w-px">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="block m-auto text-red-500 h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                                        </svg>
<!--                                        <svg xmlns="http://www.w3.org/2000/svg" class="block m-auto text-orange-500 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">-->
...
<!--                                        </svg>-->
                                    ...
                                    <td class="border-t ">
                                        <Link value="Edit" :href="route('user.registries.show', [company, registry])"
                                              class="px-6 py-3 flex items-center focus:text-indigo-500">{{ test(registry.id) }} dni
                                        </Link>
                                    </td>
                                    <td class="border-t">
                                        <Link value="Edit" :href="route('user.registries.show', [company, registry])"
                                    ...
                                    <td class="border-t">
                                        <Link value="Edit" v-if="! expired(registry.id)" :href="route('user.dashboard', [company, registry])"
