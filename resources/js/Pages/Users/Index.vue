                    ...
                    <div class="bg-white rounded-md shadow overflow-x-auto">
                        <table class="w-full whitespace-nowrap">
                            ...
                            <tr v-for="user of users.data"  :key="user.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                                ...
                                <td class="border-t">
                                    <Link value="Edit" :href="route('users.edit', user)" class="px-6 py-4 flex items-center focus:text-indigo-500"> Radisson Blu </Link>
                                </td>
                                <td class="border-t">
                                    <Link value="Edit" :href="route('users.edit', user)" class="px-6 py-4 flex items-center focus:text-indigo-500"> Zakopane </Link>
                                </td>
                            </tr>
                        </table>
                    </div>
