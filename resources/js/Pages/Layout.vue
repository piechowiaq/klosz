        ...
        <div class="md:h-screen md:flex md:flex-col">
            <div class="md:flex md:flex-shrink-0">
                ...
                <div class="bg-white border-b w-full p-4 md:py-0 md:px-12 text-sm md:text-md flex justify-between items-center">
                    <div class="mt-1 mr-4">Acme Corporation</div>
                ...
                <div class="md:flex md:flex-grow md:overflow-hidden">
                    ...
                    <div class="mb-4">
                        <a href="https://demo.inertiajs.com/organizations" class="flex items-center group py-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" class="w-4 h-4 mr-2 fill-indigo-400 group-hover:fill-white">
                    ...
                    <div class="mb-4">
                        <a href="https://demo.inertiajs.com/reports" class="flex items-center group py-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="w-4 h-4 mr-2 fill-white">
