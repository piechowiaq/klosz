<template>
    <div class="relative">
        <button @click="isOpen = !isOpen" class="relative flex z-10 block focus:outline-none">
            <span>John Doe</span>
        ...
        <div v-if="isOpen" class="absolute right-0 mt-2 py-2 w-40 bg-white rounded  text-sm shadow-xl">
            <Link :href="`/users/${user.id}/edit`" class="block px-6 py-2 hover:bg-indigo-500 hover:text-white">My Profile</Link>
